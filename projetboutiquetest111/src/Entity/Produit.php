...
class Produit
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Fournisseur", mappedBy="produits")
     */
    private $yes;
    ...
    public function addYe(Fournisseur $ye): self
    {
    ...
    public function removeYe(Fournisseur $ye): self
    {
        if ($this->yes->contains($ye)) {
